...
from sqlalchemy import String, Text, DateTime, ForeignKey, Boolean, func, UniqueConstraint
...
class SpecialistProfile(Base):
    ...
    position: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)  # "Косметолог", "Масажист"
